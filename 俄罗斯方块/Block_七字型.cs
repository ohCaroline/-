...
namespace 俄罗斯方块
{
    class Block_七字型 : Block
    {
        ...
        public Block_七字型()
        {
            ...
            Shape3 = new int[4, 4];
            Shape4 = new int[4, 4];
            Shape1[3, 2] = Shape1[2, 2] = Shape1[1, 2] = Shape1[1, 1] = 1;
            Shape2[3, 2] = Shape2[3, 1] = Shape2[3, 0] = Shape2[2, 2] = 1;
            Shape3[3, 1] = Shape3[3, 0] = Shape3[2, 0] = Shape3[1, 0] = 1;
            Shape4[2, 0] = Shape4[1, 2] = Shape4[1, 1] = Shape4[1, 0] = 1;
        }
